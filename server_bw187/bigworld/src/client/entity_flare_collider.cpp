 ...
 *
 *	@return	PhotonOccluder::NONE if there was no collision,
 *			else PhotonOccluder::SOLID.
 */
PhotonOccluder::Result
 ...
 *
 *	@return A PhotonOccluder::Result inidicating the type of occlusion.
 */
PhotonOccluder::Result
		...
		const Matrix & lightToClip )
{
	...
	const BoundingBox & bb = pModel->boundingBox();
