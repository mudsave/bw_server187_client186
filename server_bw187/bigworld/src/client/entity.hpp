...
public:
	Entity( EntityType & pType, ObjectID id, Vector3 & pos, float * pAuxVolatile,
	...
	void enterWorld( SpaceID spaceID, ObjectID vehicleID, bool transient );
	...
	Entity * pVehicle() const			{ return pVehicle_; }
	...
	*
	*	This function chacks whether this Entity has the given target capability.
	*
...
private:
	...
	class PrerequisitesOrder	* prerequisitesOrder_;
