...
#define PY_METHOD_ATTRIBUTE_REAL_ENTITY( METHOD_NAME )						\
...
#define PY_METHOD_ATTRIBUTE PY_METHOD_ATTRIBUTE_REAL_ENTITY
...
public:
	...
	EventNumber addHistoryEvent( uint8 type,
	...
	Entity * traverseGateway( SpaceID, const Vector3 & );
	...
	void navLoc( NavLoc & n )		{ navLoc_ = n; }
	...
	void delControlledBy( ObjectID deadID );
