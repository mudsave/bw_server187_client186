 ...
 *	PY_METHOD_ATTRIBUTE, to allow EntityExtras (which are not PyObjects)
 *	to use most of the standard macros in PyObjectPlus to define
 *	their Python-callable methods.
 */
#define PY_METHOD_ATTRIBUTE_ENTITY_EXTRA( METHOD_NAME )						\
