...
public:
	...
	VisionController( float fieldOfView = 1.f, float visionRange = 20.f,
	...
	float	fieldOfView()			{ return fieldOfView_; }
	float	visionRange()			{ return visionRange_; }

	void setVisionRange( float fieldOfView, float range );
...
private:
	...
	std::vector< ObjectID > * pOnloadedVisible_;
};
