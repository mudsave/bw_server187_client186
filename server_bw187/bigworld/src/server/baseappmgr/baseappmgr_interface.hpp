...
BEGIN_MERCURY_INTERFACE( BaseAppMgrInterface )
	...
	// TODO: Might get rid of this one now.
	...
	MF_BEGIN_BASE_APP_MGR_MSG( resourceVersionControl )
		uint32				version;
		uint32				activity;
		// activity 0: stocktake complete, start loading
	END_STRUCT_MESSAGE()
	...
	MF_RAW_BASE_APP_MGR_MSG( prepareForRestoreFromDB )
