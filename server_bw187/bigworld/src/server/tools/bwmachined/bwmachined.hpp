...
public:
	...
	static BWMachined *pInstance() { return s_pInstance_; }
...
protected:
	...
	class PacketTimeoutHandler : public TimeQueueHandler
	{
	public:
		void handleTimeout( TimeQueueId id, void *pUser );
		void onRelease( TimeQueueId id, void *pUser );
	};

	PacketTimeoutHandler packetTimeoutHandler_;

	class UpdateHandler : public TimeQueueHandler
	{
	public:
	...
	Listeners birthListeners_, deathListeners_;
	UserMap users_;

	static BWMachined *s_pInstance_;
