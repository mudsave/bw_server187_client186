...
/**
 *	Set the function to call periodically when we are blocked
 */
INLINE void ServerConnection::blockedCallback( void (*requestBlockedCB)() )
{
	requestBlockedCB_ = requestBlockedCB;
}
