...
<body>
	...
	<div id="navigation" class="helpnavmenu">
		...
		<!-- CLUSTER CONTROL COLLAPSED -->
			<a href="" onclick="window.open('/cc/help','_parent');"><img src="/static/images/cluster_control.png" alt=""/>ClusterControl Help</a>
		</li>

		<li py:if="section == 'cluster_control'" class="top-level current">
		<!-- CLUSTER CONTROL EXPANDED -->
			<a href="/cc/static/html/help_right_pane.html#Top"
				target="right_pane"><img src="/static/images/cluster_control.png" alt=""/>ClusterControl Help</a>
		...
		<!-- LOG VIEWER COLLAPSED -->
			<a href="" onclick="window.open( '/log/help', '_parent' );"><img src="/static/images/log_viewer.png" alt=""/>LogViewer Help</a>
		</li>

		<li py:if="section == 'log_viewer'" class="top-level current">
		<!-- LOG VIEWER EXPANDED -->
			<a href="/log/static/html/help_right_pane.html#Top" target="right_pane"><img src="/static/images/log_viewer.png" alt=""/>LogViewer Help</a>
			<ul class="level-two-help">
				<li class="not-current">
		...
		<!-- STATGRAPHER COLLAPSED -->
			<a href="" onclick="window.open( '/statg/help', '_parent' );"><img src="/static/images/stat_grapher.png" alt=""/>StatGrapher Help</a>
		</li>

		<li py:if="section == 'stat_grapher'" class="top-level current">
		<!-- STATGRAPHER EXPANDED -->
			<a href="/statg/static/html/help_right_pane.html#Top" target="right_pane"><img src="/static/images/stat_grapher.png" alt=""/>StatGrapher Help</a>
			<ul class="level-two-help">
			<li class="not-current">
