...
function doSetColour( newColour )
{
	...
	//console.log( "Current colour for " + colourPicker.currentStat +
	//	" is to be set to: " + newColour );
	//console.log(
...
function doResize()
{
	...
	var offsets = getOffsets( graphTable );
	var xoffset = offsets[0];
	var yoffset = offsets[1];

	var finalHeight = height - yoffset - padding;
	var finalWidth = width - xoffset - padding;


	graphTable.style.height = finalHeight + "px";
	graphTable.style.width = finalWidth + "px";

	var legendDiv = document.getElementById( "legendDiv" );
	legendDiv.style.height = finalHeight + "px";
