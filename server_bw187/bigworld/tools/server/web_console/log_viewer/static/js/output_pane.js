	...
	OutputPane: function( anchorElt, params )
	{
		...
		this.setLoading = function( isLoading )
		{
			...
			if (isLoading)
			{
				...
				var pcComplete = this.query ?
					Math.round( 100 * Math.max( this.query.seen / this.query.currTotal,
								this.recCount / this.bufSize ) ) : 0;
			...
			else
			{
				...
				else if (this.query.seen < this.query.currTotal)
				{
					...
					(this.alreadyDisplayed == this.recCount)) || this.query.live)
				{
