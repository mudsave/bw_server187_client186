	...
	Query: function( live )
	{
		...
		this.getServerArgs = function( outputPane )
		{
			...
			else
			{
				...
				// TODO: Put something here to catch invalid date formats
				time = (new Date( noMsTime )).getTime() / 1000.0 + msTime + ServerTime.timezoneOffset;
