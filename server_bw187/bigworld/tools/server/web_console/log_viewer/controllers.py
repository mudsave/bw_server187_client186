...
class LogViewer( module.Module ):
	...
	def fetch( self,
		...
		try:
			...
			try:
				...
				raise ajax.Error, ("Regex error", str( e ))
	...
	def fetchQueries( self ):
		...
		# Make sure default comes first
		def defaultFirst( a, b ):
			if a.name == "default":	return -1
			if b.name == "default": return 1
			return cmp( a.id, b.id )
		queries.sort( defaultFirst )
