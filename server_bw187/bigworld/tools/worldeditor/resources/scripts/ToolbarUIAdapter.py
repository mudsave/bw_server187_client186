...
def actLightAmbientOnlyExecute():
	BigBang.romp.setTime( 12.0 )

def actLightAmbientDirectionalExecute():
	BigBang.romp.setTime( 16.0 )

def actLightGameExecute():
	BigBang.romp.setTime( 18.0 )

#---------------------snaps------------------------------

def itemMode():
	return ( BigBang.tool() == bd.itemTool )

def actShellSnapsExecute():
	BigBang.setOptionVector3( "snaps/movement", BigBang.getOptionVector3( "shellSnaps/movement" ) )
	BigBang.setOptionFloat( "snaps/angle", BigBang.getOptionFloat( "shellSnaps/angle" ) )
	newSnaps = BigBang.getOptionVector3( "snaps/movement" )
	BigBang.addCommentaryMsg( "Movement snaps are %f,%f,%f" % (newSnaps[0],newSnaps[1],newSnaps[2]) )
	BigBang.addCommentaryMsg( "Rotation snaps are %f" % BigBang.getOptionFloat( "snaps/angle" ) )

def actFreeSnapsExecute():
	newSnaps = ( 0.1, 0.1, 0.1 )
	BigBang.setOptionVector3( "snaps/movement", newSnaps )
	BigBang.setOptionFloat( "snaps/angle", 1 )
	BigBang.addCommentaryMsg( "Movement snaps are %f,%f,%f" % (newSnaps[0],newSnaps[1],newSnaps[2]) )
	BigBang.addCommentaryMsg( "Rotation snaps are %f" % BigBang.getOptionFloat( "snaps/angle" ) )
...
def spdMiscSnapsXAdjust( value, min, max ):
	...
	BigBang.setOptionVector3( "snaps/movement", newSnaps )
	BigBang.addCommentaryMsg( "Movement snaps are %0.1f,%0.1f,%0.1f" %
