...
class OptionToggle:
	...
	def __call__( self ):
		oldValue = ModelEditor.opts.readInt( self.path )
...
intReader = ModelEditor.opts.readInt
floatReader = ModelEditor.opts.readFloat
stringReader = ModelEditor.opts.readString
vector3Reader = ModelEditor.opts.readVector3
vector4Reader = ModelEditor.opts.readVector4
...
def disableFloor( value ):
	BigBang.setOptionInt( "settings/useFloor", 0 )	
...
toggleButtons = (
	...
	("actShowTrees",				"settings/showTrees",			0 ),
	("actShowWater",				"settings/showWater",			0 ),
