...
public:
	...
	virtual CString name() { return name_; }
	...
	virtual const std::string& UIDesc() { return uiDesc_; }
...
public:
	...
	std::string UIDescExtra()
	{
		if (textureFeed_ == "")
		{
			return "This texture can be assigned a texture feed by right clicking.";
		}
		else
		{
			return "This texture is currently using the texture feed name \"" + textureFeed_ + "\".";
		}
