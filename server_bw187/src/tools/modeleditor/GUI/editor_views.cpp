...
void __stdcall ChoiceView::elect()
{
		...
		iter++)
	{
		...
		possibleValuesMap[ pDS->asInt( 0 ) ] = pDS->sectionName();
...
void __stdcall ColourView::elect()
{
	...
	ColourPropertyItem* newItem = new ColourPropertyItem(property_.name(), buf, 1 /*property_.getGroupDepth() + 1*/ );
	newItem->setChangeBuddy(this);
	...
	IntPropertyItem* newColItem = new IntPropertyItem("Red", (int)(c.r));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);

	newItem->descName( property_.descName() );
	newColItem->UIDesc( property_.UIDesc() + " - red" );

	newColItem->setRange( 0, 255 );
	propertyItems_.push_back(newColItem);

	newColItem = new IntPropertyItem("Green", (int)(c.g));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);

	newItem->descName( property_.descName() );
	newColItem->UIDesc( property_.UIDesc() + " - green" );

	newColItem->setRange( 0, 255 );
	propertyItems_.push_back(newColItem);

	newColItem = new IntPropertyItem("Blue", (int)(c.b));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);

	newItem->descName( property_.descName() );
	newColItem->UIDesc( property_.UIDesc() + " - blue" );

	newColItem->setRange( 0, 255 );
	propertyItems_.push_back(newColItem);

	newColItem = new IntPropertyItem("Alpha", (int)(c.a));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);

	newItem->descName( property_.descName() );
	newColItem->UIDesc( property_.UIDesc() + " - alpha" );

	newColItem->setRange( 0, 255 );
	propertyItems_.push_back(newColItem);

	propTable_->propertyList()->collapseGroup( newItem,
		propTable_->addView( this ) + 1 );
}
...
void ColourView::onChange( bool transient )
{
	...
	{
		char buf[64];
		sprintf( buf, "%d , %d , %d , %d", (int)(c2.r), (int)(c2.g), (int)(c2.b), (int)(c2.a) );
		item()->set( buf );
...
void __stdcall Vector4View::elect()
{
	...
	char buf[256];
	sprintf( buf, "%.2f , %.2f , %.2f , %.2f", (float)(c.x), (float)(c.y), (float)(c.z), (float)(c.w) );
	...
	FloatPropertyItem* newColItem = new FloatPropertyItem("x", (float)(c.x));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);
	...
	newColItem = new FloatPropertyItem("y", (float)(c.y));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);
	...
	newColItem = new FloatPropertyItem("z", (float)(c.z));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);
	...
	newColItem = new FloatPropertyItem("w", (float)(c.w));
	newItem->addChild( newColItem );
	newColItem->setChangeBuddy(this);
...
void Vector4View::onChange( bool transient )
{
	...
	{
		char buf[256];
		sprintf( buf, "%.2f , %.2f , %.2f , %.2f", c2.x, c2.y, c2.z, c2.w );
		item()->set( buf );
