...
public:
	...
	bool callString2( const std::string& fnName, const std::string& param1, const std::string& param2 );
	...
	void contextMenuGetItems( const std::string& type, const std::string path, std::map<int,std::string>& items );
