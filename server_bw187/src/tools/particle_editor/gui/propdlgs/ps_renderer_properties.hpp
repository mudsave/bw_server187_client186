...
#include "gui/controls/ccombobox_auto_complete.hpp"
...
private:
	...
	CComboBoxAutoComplete   meshName_;
	controls::ImageButton   meshNameDirectoryBtn_;
    CEdit                   meshNameDirectoryEdit_;
    CComboBoxAutoComplete   meshMaterialFX_;
    CComboBoxAutoComplete   meshSort_;
	CComboBoxAutoComplete   visualName_;
	...
	CButton                 circular_;
	CComboBoxAutoComplete   ampTextureName_;
    ...
    controls::CSeparator    hline1_;
    controls::CSeparator    hline2_;
    controls::CSeparator    hline3_;
    controls::CSeparator    hline4_;
    controls::CSeparator    hline5_;
    controls::CSeparator    hline6_;
    bool                    filterChanges_;
};
