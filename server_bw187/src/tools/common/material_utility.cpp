...
ComObjectWrap<ID3DXEffect> MaterialUtility::effect(
	Moo::EffectMaterial* material, int effectIndex )
{
	if (material && material->nEffects() > 0)
	{
		Moo::ManagedEffectPtr pEffect = material->pEffect(effectIndex);
		if ( pEffect )
		{
 ...
 */
int MaterialUtility::numTechniques( Moo::EffectMaterial* material )
{
	int n = 0;	
 ...
 */
int MaterialUtility::listTechniques(
 ...
 */
bool MaterialUtility::viewTechnique(
	Moo::EffectMaterial* material,
	int index )
{
	...
	const std::string& name )
{
	...
	{
		ERROR_MSG( "Technique %s not found in material %lx\n", name.c_str(), (int)material );
		return false;
	}
}
 ...
 *	found.
 */
int MaterialUtility::techniqueByName(
	Moo::EffectMaterial* material,
	const std::string& name )
{
	//Write out techniques
 ...
 */
int MaterialUtility::currentTechnique( Moo::EffectMaterial* material )
{
 ...
 *	the material has.
 */
int MaterialUtility::numProperties( Moo::EffectMaterial* material )
{
	...
	bool worldBuilderEditableOnly /*= false*/ )
{
    ...
    {
        effects.push_back( material->pEffect(i)->resourceID() );
    }
	...
	{
		pSection->writeInt( "collisionFlags", material->collisionFlags_ );
		pSection->writeInt( "materialKind", material->materialKind_ );
	}
}
...
void MaterialUtility::setTexture( Moo::EffectMaterial* material,
