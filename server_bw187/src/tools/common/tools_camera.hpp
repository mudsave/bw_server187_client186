...
public:
	...
	void mode ( unsigned mode )
	{
		...
		GUI::Manager::instance()->update(); // Update the main toolbar
	}
	int mode()
	{
	...
	void zoomToExtents( bool animate, BoundingBox& box = BoundingBox::s_insideOut_ );
...
private:
	...
	MouseLookCamera * mouseLookCamera_;
