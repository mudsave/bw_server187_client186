...
class PageOptionsEnvironment : public CFormView, public GUITABS::Content
{
    ...
    (
        "Environment",              // short name of page
        "Environment Options",      // long name of page
        290,                        // default width
        500,                        // default height
        NULL                        // icon
    )
...
private:
    ...
    CSliderCtrl                     sunAngleSlider_;
    controls::EditNumeric           sunAngleEdit_;
    CSliderCtrl                     moonAngleSlider_;
