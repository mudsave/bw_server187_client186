...
/*virtual*/ bool 
ElevationCodecTerragen::canHandleFile
(
...
)
{
    ...
    try
    {
        ...
        for (unsigned int y = 0; y < image.height(); ++y)
        {
            ...
            {
                int16 elevation = 
                    Math::lerp(image.getValue(x, y), minv, maxv, 0, 10000);
...
/*virtual*/ bool ElevationCodecTerragen::canLoad() const
{
    return true;
}


/*virtual*/ bool ElevationCodecTerragen::canSave() const
{
    return true;
}


/*static*/ ElevationCodecTerragen &ElevationCodecTerragen::instance()
{
    static ElevationCodecTerragen s_instance;
    return s_instance;
}
