...
#ifndef ELEVATION_CODEC_TERRAGEN_HPP
#define ELEVATION_CODEC_TERRAGEN_HPP
 ...
 */
class ElevationCodecTerragen : public ElevationCodec
{
public:
    ...
    static ElevationCodecTerragen &instance();
};

#endif // ELEVATION_CODEC_TERRAGEN_HPP
