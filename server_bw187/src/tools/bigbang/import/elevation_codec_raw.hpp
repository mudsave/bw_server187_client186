...
#ifndef ELEVATION_CODEC_RAW_HPP
#define ELEVATION_CODEC_RAW_HPP
 ...
 */
class ElevationCodecRAW : public ElevationCodec
{
public:
    ...
    static ElevationCodecRAW &instance();
};

#endif // ELEVATION_CODEC_RAW_HPP
