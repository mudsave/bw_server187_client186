...
#ifndef ELEVATION_CODEC_DTED_HPP
#define ELEVATION_CODEC_DTED_HPP
 ...
 */
class ElevationCodecDTED : public ElevationCodec
{
public:
    ...
    static ElevationCodecDTED &instance();
};

#endif // ELEVATION_CODEC_DTED_HPP
