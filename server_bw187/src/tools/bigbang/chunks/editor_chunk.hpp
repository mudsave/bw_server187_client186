...
public:
	...
	{
		return updateFlags_.thumbnail_ != 0;
	}
...
private:
	...
	struct UpdateFlags
	{
		unsigned int lighting_;
		unsigned int thumbnail_;
		unsigned int shadow_;
	}
	updateFlags_;
