...
public:
	 ...
	 */
	void edRecalculateLighting( StaticLighting::StaticLightContainer& lights );
	...
	Moo::EffectMaterial* findMaterialByName( const std::string& name ) const;
...
private:
	...
	void edit( Moo::EffectMaterial* material, ChunkItemEditor & editor );
};
