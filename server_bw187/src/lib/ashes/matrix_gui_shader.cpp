...
PY_BEGIN_ATTRIBUTES( MatrixGUIShader )
	 ...
	 *
	 *	This attribute specifies the PyMatrixProvider that is used to transform
	 ...
	 *	the top right).
	 *
	 *	If blend is 0 (false) then any changes to the target PyMatrixProvider
	 ...
	 *	that specified by the target PyMatrixProvider.  If this attribute is
 ...
 *
 *	@param	target (optional)	The initial target PyMatrixProvider.
 *
