...
PY_BEGIN_ATTRIBUTES( AlphaGUIShader )
	 ...
	 *
	 *	It is a float, and is interpreted as either the x or y component 
	 *	of a Vector2, depending on mode.
	 *
	 *	@type Float
	 */
	 ...
	 *	width/height specified by the start and stop attributes.  See the mode
