 ...
 */
MatrixProvider * BaseCamera::viewMatrixProvider() const
{
	return new CameraMatrixProvider( this, &BaseCamera::view_ );
}
 ...
 *	This method returns a matrix provider for this camera's view matrix
 */
MatrixProvider * BaseCamera::invViewMatrixProvider() const
{
	return new CameraMatrixProvider( this, &BaseCamera::invView_ );
}
