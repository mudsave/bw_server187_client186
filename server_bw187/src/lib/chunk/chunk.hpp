...
private:
	...
	bool loadBoundaries( DataSectionPtr pSection );

	ChunkBoundary::Portal* bind( Chunk * pChunk );
	void onBound( Chunk* other, ChunkBoundary::Portal* portal );
	...
	static std::vector<TouchFunction> * touchType_;
