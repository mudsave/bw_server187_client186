...
{
public:
	GenPositionProperty( const std::string & name, MatrixProxyPtr pMatrix );
...
{
public:
	GenRotationProperty( const std::string & name, MatrixProxyPtr pMatrix );
...
{
public:
	GenScaleProperty( const std::string & name, MatrixProxyPtr pMatrix );
...
public:
	...
	IntProxyPtr	pInt()	{ return pInt_; }
	DataSectionPtr pChoices() { return pChoices_; }
