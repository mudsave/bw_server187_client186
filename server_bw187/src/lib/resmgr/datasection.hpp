...
public:
	...
	const SearchIterator& endOfSearch()
	{
	...
	/// appropriate.
	virtual DataSectionPtr newSection( const std::string &tag ) = 0;
	...
	/// section.
	virtual DataSectionPtr findChild( const std::string &tag ) const = 0;
	...
	virtual bool setBool( bool value, char *format = "%s" );

	/// This method sets the datasection to an integer value.
	virtual bool setInt( int value, char *format = "%d" );

	/// This method sets the datasection to a long value.
	virtual bool setLong( long value, char *format = "%d" );

	/// This method sets the datasection to a floating-point value.
	virtual bool setFloat( float value, char *format = "%f" );

	/// This method sets the datasection to a double value.
	virtual bool setDouble( double value, char *format = "%f" );
	...
	virtual bool setVector2( const Vector2 &value, char *format = "%f %f" );

	/// This method sets the datasection to a Vector3 value.
	virtual bool setVector3( const Vector3 &value, char *format = "%f %f %f" );

	/// This method sets the datasection to a Vector4 value.
	virtual bool setVector4( const Vector4 &value, char *format = "%f %f %f %f" );

	/// This method sets the datasection to a Matrix34 value.
	virtual bool setMatrix34( const Matrix &value,
		char *vectorFormat = "%f %f %f" );
	...
	bool writeBool(
			const std::string &tagPath, bool value, char *format = "%s" );

	/// This method writes an integer value to the tag specified.
	bool writeInt( const std::string &tagPath, int value, char *format = "%d" );

	/// This method writes a long value to the tag specified.
	bool writeLong(
			const std::string &tagPath, long value, char *format = "%d" );

	/// This method writes a floating-point value to the tag specified.
	bool writeFloat(
			const std::string &tagPath, float value, char *format = "%f" );

	/// This method writes a double floating-point value to the tag specified.
	bool writeDouble(
			const std::string &tagPath, double value, char *format = "%f" );
