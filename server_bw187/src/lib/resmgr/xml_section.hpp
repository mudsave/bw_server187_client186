...
protected:
	...
	//@{
	virtual DataSectionPtr findChild( const std::string & tag ) const;
	...
	//@{
	virtual bool setBool( bool value, char *format );
	virtual bool setInt( int value, char *format );
	virtual bool setLong( long value, char *format );
	virtual bool setFloat( float value, char *format );
	virtual bool setDouble( double value, char *format );
	virtual bool setString( const std::string &value );
	virtual bool setWideString( const std::wstring &value );
	virtual bool setVector2( const Vector2 &value, char *format );
	virtual bool setVector3( const Vector3 &value, char *format );
	virtual bool setVector4( const Vector4 &value, char *format );
	virtual bool setMatrix34( const Matrix &value, char *vectorFormat );
