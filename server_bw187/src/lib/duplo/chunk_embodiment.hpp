...
{
public:
	ChunkEmbodiment( int wantFlags = 0 );
	ChunkEmbodiment( PyObject * pPyObject, int wantFlags = 0 );
...
{
public:
	ChunkDynamicEmbodiment( int wantFlags = 0 );
	ChunkDynamicEmbodiment( PyObject * pPyObject, int wantFlags = 0 );
...
{
public:
	ChunkStaticEmbodiment( int wantFlags = 0 );
	ChunkStaticEmbodiment( PyObject * pPyObject, int wantFlags = 0 );
