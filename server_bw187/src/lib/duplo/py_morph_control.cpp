...
PY_BEGIN_ATTRIBUTES( PyMorphControl )
	 ...
	 *
	 *	This attribute takes a PyMatrixProvider, whose elements are mapped to 
	 ...
	 *
	 *	Each element of the PyMatrixProvider is treated as the blend weight
	 ...
	 *	supplied in the input attribute, which is a PyMatrixProvider, whose
 ...
 *	using weights supplied in a PyMatrixProvider.
 *
