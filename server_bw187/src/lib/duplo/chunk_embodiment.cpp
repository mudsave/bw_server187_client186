 ...
 *	Constructor.
 */
ChunkEmbodiment::ChunkEmbodiment( int wantFlags ) :
	ChunkItem( wantFlags ),
	pPyObject_( NULL )
{
}
 ...
 *	Constructor.
 */
ChunkEmbodiment::ChunkEmbodiment( PyObject * pPyObject, int wantFlags ) :
	ChunkItem( wantFlags ),
...
{
	if (s_converters_ == NULL) s_converters_ = new Converters;
 ...
 *	Constructor.
 */
ChunkDynamicEmbodiment::ChunkDynamicEmbodiment( int wantFlags ) :
...
ChunkDynamicEmbodiment::ChunkDynamicEmbodiment(
		PyObject * pPyObject, int wantFlags ) :
...
{
	MF_ASSERT( pSpace_ && !pSpace_->ticking() );
 ...
 *	Constructor.
 */
ChunkStaticEmbodiment::ChunkStaticEmbodiment( int wantFlags ) :
	ChunkEmbodiment( wantFlags | 8 /*wantsNest*/ ),
	pSpace_( NULL )
{
}
...
ChunkStaticEmbodiment::ChunkStaticEmbodiment(
		PyObject * pPyObject, int wantFlags ) :
	ChunkEmbodiment( pPyObject, wantFlags | 8 /*wantsNest*/ ),
	pSpace_( NULL )
{
}
