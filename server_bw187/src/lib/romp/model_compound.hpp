...
public:
	...
	~ModelCompoundInstance();
	bool init( ModelCompound* pModelCompound, 
 ...
 *	more efficiently.
 */
class ModelCompound : public ReferenceCount
{
public:
	~ModelCompound();
	...
	static ModelCompoundInstance* get( const std::string& name, 
		const Matrix& transform, uint32 batchCookie );
...
private:
	...
	typedef StringHashMap<ModelCompound*> CompoundMap;
