	...
	PyObjectPlus( &Weather::s_type_ )
{
	...
	MF_WATCH( "Client Settings/Weather/out: windY", settings_.windY,
		Watcher::WT_READ_ONLY, "Current wind velocity on the Y axis" );
...
void Weather::tick( float dTime )
{
	...
	Vector2 windLast( settings_.windX, settings_.windY );
