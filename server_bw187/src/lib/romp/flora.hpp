...
public:
	...
	Moo::TerrainBlockPtr getTerrainBlock( const Vector3 & pos, Vector3 & relativePos, const Vector2* referencePt = NULL ) const;
...
private:
	...
	mutable Moo::TerrainBlock::FindDetails details_;
