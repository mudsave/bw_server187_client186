...
public:
	...
	void addWorldSpace(	const Vector3& start, const Vector3& end, 
						Moo::PackedColour	colour	= 0xffffffff,
						uint32				life	= 0 );
	// draw a line in screen space
	void addScreenSpace( const Vector4& start, const Vector4& end, 
		Moo::PackedColour colour = 0xffffffff );
	
	// draw an axis aligned bounding box
	// TODO: optimize by using strips
	void addBoundingBox( const BoundingBox& bb, const Matrix& world,
		Moo::PackedColour	colour	= 0xffffffff,
		uint32				life	= 0 );
