...
public:
	...
	void simulateBlock( Moo::EffectMaterialPtr effect, SimulationTextureBlock* block );
	...
	static SimulationManager&		instance( ) { return instance_; }
private:
	...
	static SimulationManager		instance_;
	static float					maxIdleTime_;
	static int						maxTextureBlocks_;
