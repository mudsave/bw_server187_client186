...
public:
	...
	virtual	void getThumbnail( int index, CImage& img, int w, int h, ThumbnailUpdater* updater ) = 0;
...
public:
	...
	void init( ListProvider* provider, XmlItemVec* customItems = 0, bool clearSelection = true );
