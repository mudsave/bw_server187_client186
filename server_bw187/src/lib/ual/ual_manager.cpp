...
UalManager* UalManager::instance_ = 0;
...
{
	UalFavourites::instance()->setChangedCallback( new UalFunctor0< UalManager >( this, &UalManager::favouritesCallback ) );
	UalHistory::instance()->setChangedCallback( new UalFunctor0< UalManager >( this, &UalManager::historyCallback ) );
}
...
UalManager* UalManager::instance()
{
	if ( !instance_ )
		instance_ = new UalManager();
...
void UalManager::fini()
{
	...
	ThumbnailManager::instance()->stop();
	INFO_MSG( "UAL Manager - ... Thumbnail Manager stoped\n" );
	UalDialog::fini();
}
