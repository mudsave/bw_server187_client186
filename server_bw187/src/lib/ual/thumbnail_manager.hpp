...
public:
	 ...
	 */
	virtual bool needsCreate( const std::string& file, std::string& thumb, int& size );
	 ...
	 */
	virtual bool prepare( const std::string& file ) = 0;
	 ...
	 *  @return true if successful
	 */
	virtual bool render( const std::string& file, Moo::RenderTarget* rt ) = 0;
};
