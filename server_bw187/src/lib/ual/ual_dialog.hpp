...
// Dialog Data
	...
	// used by the loaders
	ListFileProvider* fileListProvider() { return &fileListProvider_; }
	ListXmlProvider* xmlListProvider() { return &xmlListProvider_; }
	ListXmlProvider* historyListProvider() { return &historyListProvider_; }
	ListXmlProvider* favouritesListProvider() { return &favouritesListProvider_; }
...
private:
	...
	ListFileProvider fileListProvider_;
	ListXmlProvider xmlListProvider_;
	ListXmlProvider historyListProvider_;
	ListXmlProvider favouritesListProvider_;
	...
	void handleDragMouseMove( UalItemInfo& ii, const CPoint& screenPt );
