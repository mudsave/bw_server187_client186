...
bool XmlThumbProv::isValid( const std::string& file )
{
	if ( file.empty() )
		return false;
...
bool XmlThumbProv::needsCreate( const std::string& file, std::string& thumb, int& size )
{
...
bool XmlThumbProv::prepare( const std::string& file )
{
	// should never get called
	return false;
}

bool XmlThumbProv::render( const std::string& file, Moo::RenderTarget* rt )
{
	// should never get called
	return false;
}
