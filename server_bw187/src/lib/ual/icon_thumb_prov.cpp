...
bool IconThumbProv::isValid( const std::string& file )
{
	if ( !inited_ )
		init();
...
bool IconThumbProv::needsCreate( const std::string& file, std::string& thumb, int& size )
{
...
bool IconThumbProv::prepare( const std::string& file )
{
	// should never get called
	return false;
}

bool IconThumbProv::render( const std::string& file, Moo::RenderTarget* rt )
{
	// should never get called
	return false;
}
