...
/**
 *	UalHistory: favourites manager for the Ual Dialog
 */
...
UalFavourites* UalFavourites::instance_ = 0;
...
UalFavourites* UalFavourites::instance()
{
	if ( !instance_ )
		instance_ = new UalFavourites();
	return instance_;
}
