...
public:
	...
	virtual VFolderItemDataPtr getNextChild( CImage& img ) = 0;
	...
	virtual ListProvider* getListProvider()
		{ return listProvider_; }
	virtual void getThumbnail( VFolderItemDataPtr data, CImage& img ) = 0;
