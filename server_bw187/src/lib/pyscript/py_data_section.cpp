...
PyObject * PyDataSection::pyNew( PyObject * args )
{
	...
	return new PyDataSection( new XMLSection( name ) );
}
 ...
 */
int PyDataSection::s_length( PyObject * self )
{
...
{
	BinaryPtr pBinary = new BinaryBlock( v.data(), v.length() );
...
{																				\
	...
	PyObject * pTuple;															\
																				\
	if (!PyArg_ParseTuple( args, "sO", &path, &pTuple ) ||						\
		!PyTuple_Check( pTuple ))												\
	{																			\
		PyErr_SetString( PyExc_TypeError, "Expected string and a tuple." );		\
		return NULL;															\
	}																			\
																				\
	int size = PyTuple_Size( pTuple );											\
	std::vector< TYPE > values( size );											\
																				\
	for (int i = 0; i < size; i++)												\
	{																			\
		if (Script::setData( PyTuple_GetItem( pTuple, i ), values[i] ) != 0)	\
		{																		\
 ...
 *
 *	@return					the wide string contained in the specified section.
 */
 ...
 *
 *	@return					the int contained in the specified section, 0
 *							otherwise.
 */
 ...
 *
 *	@return					the float contained in the specified section, 0
 *							otherwise.
 */
 ...
 *  beginning of the text for the named section.  Any trailing text is ignored.
 *	If it gets this, it returns the two floats as a Vector3, otherwise it
 *	returns (0, 0, 0).
 *
 *	If there is more than one section with the specified name, then only the
 *	first one is used.
 ...
 *  beginning of the text for the named section.  Any trailing text is ignored.
 *	If it gets this, it returns the two floats as a Vector4, otherwise it
 *	returns (0, 0, 0, 0).
 *
 *	If there is more than one section with the specified name, then only the
 *  first one is used.
 ...
 *
 *	@return					the Matrix contained in the specified section, a
 ...
 *
 *	This function creates a subsection of the specified name for each element
 *	of the supplied tuple, writing the corresponding integer from the
 *	tuple as the contents of that subsection.
 *
 *	For example, the following statement:
 *
 *	@{
 ...
 *
 *	This function has no effect on existing subsections of the same name.  A
 *	new subsection is always created for each element in the tuple.
 *
 *	@param	sectionName	the name of the subsection to create.
 *	@param	values		the tuple of integers to use as values for the new
 *						subsections.
 */
 ...
 *
 *	This function creates a subsection of the specified name for each element
 *	of the supplied tuple, writing the corresponding float from the tuple
 *	as the contents of that subsection.
 *
 *	For example, the following statement:
 *
 ...
 *
 *	@param	sectionName	the name of the subsection to create.
 *	@param	values		the tuple of floats to use as values for the new
 *						subsections.
 */
 ...
 *
 *	This function creates a subsection of the specified name for each element
 *	of the supplied tuple, writing the corresponding Vector2 from the
 *	tuple as the contents of that subsection.
 *
 *	For example, the following statement:
 *
 ...
 *
 *	@param	sectionName	the name of the subsection to create.
 *	@param	values		the tuple of Vector2s to use as values for the new
 *						subsections.
 */
 ...
 *
 *	This function creates a subsection of the specified name for each element
 *	of the supplied tuple, writing the corresponding Vector3 from the
 *	tuple as the contents of that subsection.
 *
 *	For example, the following statement:
 *
 ...
 *
 *	@param	sectionName	the name of the subsection to create.
 *	@param	values		the tuple of Vector3s to use as values for the new
 *						subsections.
 */
 ...
 *
 *	This function creates a subsection of the specified name for each element
 *	of the supplied tuple, writing the corresponding Vector4 from the
 *	tuple as the contents of that subsection.
 *
 *	For example, the following statement:
 *
 ...
 *
 *	@param	sectionName	the name of the subsection to create.
 *	@param	values		the tuple of Vector4s to use as values for the new
 *						subsections.
 */
