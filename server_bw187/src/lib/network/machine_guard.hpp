...
/**
 * Network statistics for a single interface.  The bit statistics are expressed
 * as multiples of BIT_INCREMENT and the packet statistics are expressed as
 * multiples of PACK_INCREMENT.
 */
...
public:
	...
	u_int32_t	address_;	//!< Address of the requesting interface
...
public:
	...
	std::vector< struct InterfaceStats >
...
public:
	...
	CreateMessage()
	{
		message_ = MachineGuardMessage::CREATE_MESSAGE;
	}
