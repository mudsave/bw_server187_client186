...
/**
 *	This method returns the singleton instance of MaterialKinds.
 */
MaterialKinds& MaterialKinds::instance()
{
	static MaterialKinds instance;
	return instance;
}
...
/**
 *	This method retuns a user string associated with a material kind.
 *
											 ...
											 const std::string& keyName )
{
	...
	static const std::string err( "invalid material kind" );
	return err;
}
...
/**
 *	This method creates a description map (string -> int) used by BigBang.
 */
