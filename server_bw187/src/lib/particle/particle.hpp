...
public:
	...
	const Vector3& getTempVelocity();           //don't call this function recursively!	
	const Vector3& getVelocity( Vector3& ret ); //this function can be called recursively if you like
...
private:
	...
	static Vector3 s_velocity;	//cached working variable for the temp getVelocity method.
};
