...
/**
 *	This is the Get-Accessor for the last position of the PS.
 *
 *	@return	A point in world-space as the centre of orbiting activity.
 */
INLINE const Vector3 &OrbitorPSA::lastPosPS( void ) const
{
	return lastPosPS_;
}
...
/**
 *	This is the Set-Accessor for the position of the PS.
 *
 *	@param newVector	The new centre for the orbitor.
 */
INLINE void OrbitorPSA::lastPosPS( const Vector3 &newVector )
{
	lastPosPS_ = newVector;
}
