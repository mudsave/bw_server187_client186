...
INLINE const Vector3& Particle::getTempVelocity()
{
	s_velocity.x = float(xVel_)/256.f;
	s_velocity.y = float(yVel_)/256.f;
	s_velocity.z = float(zVel_)/256.f;
	return s_velocity;
}


INLINE const Vector3& Particle::getVelocity( Vector3& ret )
{
