...
/**
 *	This is the Get-Accessor for the static variable active. If this is set to
 ...
 */
INLINE bool ParticleSystem::active( void )
{
	return active_;
}

/**
 *	This is the Set-Accessor for the static variable active.
 *
 *	@param flag		The new value for active/inactive particle systems.
 */
INLINE void ParticleSystem::active( bool flag )
{
	active_ = flag;
}

/**
 *	This is the Get-Accessor for the static variable windVelocity. This tells
 *	all particle systems what the current wind velocity is for the frame.
 *
 *	@return	Current wind velocity as a 3D vector.
 */
INLINE const Vector3 &ParticleSystem::windVelocity( void )
{
	return windVelocity_;
}

/**
 *	This is the Set-Accessor for the static variable windVelocity. All game
 ...
 */
INLINE void ParticleSystem::windVelocity( const Vector3 &newWindVelocity )
{
 ...
 *	property.
 *
 *	@param ratio	The new value of the particle system's visible flag.
 */
