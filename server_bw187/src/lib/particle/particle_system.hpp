...
public:
	...
	static const Vector3 & windVelocity( void );
	static void windVelocity( const Vector3 & newWindVelocity );
...
private:
	...
	/// Global wind velocity to all particle systems.
	static Vector3 windVelocity_;

	/// Global activation flag to all particle systems.
	static bool active_;
	//@}
